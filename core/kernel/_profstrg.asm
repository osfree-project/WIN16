...
local	sel:word
        ...
        xor     ax,ax
        mov     rc,ax
	    @GetBlok 1000h			        ; Allocate a 64k buffer
        jc      getpps_ex               ; error: no free memory
        ...
        jc      getpps_ex2              ; error: read error
        @trace_s <"read ok",lf>
        mov     cx,ax
        mov     es,sel
        lds     si,lpszSection          ; Check the section
        call    searchsection
        jc      getpps_ex2
        lds     si,lpszEntry
        call    searchentry
