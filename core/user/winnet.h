...
WORD WINAPI WNetAbortJob(LPSTR,WORD);
...
//WORD WINAPI WNetAddConnection(LPCSTR,LPCSTR,LPCSTR);
//WORD WINAPI WNetCancelConnection(LPSTR,BOOL);
//WORD WINAPI WNetGetConnection(LPSTR,LPSTR,UINT far *);
...
WORD WINAPI WNetPropertyDialog(HWND,WORD,WORD,LPSTR,WORD);
WORD WINAPI WNetGetPropertyText(WORD,WORD,LPSTR,LPSTR,WORD,WORD);
...
WORD WINAPI WNetErrorText(WORD,LPSTR,WORD);
