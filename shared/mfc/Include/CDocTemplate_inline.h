/************************************************************************
 ...
 ------------------------------------------------------------------------
  Filename   : CDocTemplate_inline.h
  Version    : 0.10
 ...
 --[ Description ]-------------------------------------------------------
  ...
  This is the inline include file for classes CDocTemplate and
 ...
 ************************************************************************/
#ifndef CDOCTEMPLATE_INLINE_H
#define CDOCTEMPLATE_INLINE_H

// Nothing yet

#endif // CDOCTEMPLATE_INLINE_H
