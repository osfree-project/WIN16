...
document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(".accordion-button").forEach(function(t){t.addEventListener("click",function(){var e="true"===this.getAttribute("aria-expanded");this.setAttribute("aria-expanded",!e),this.classList.toggle("collapsed");var n=document.getElementById(this.getAttribute("aria-controls"));n&&n.classList.toggle("show")})})});