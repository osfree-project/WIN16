/************************************************************************
 ...
 --[ Description ]-------------------------------------------------------
  ...
  This is the inline include file for class CDocument - a class for
  representing documents - this class is never instantiated directly -
  it is always the basis for some other class which then holds the
  actual data.
 ...
 ************************************************************************/
#ifndef CDOCUMENT_INLINE_H
#define CDOCUMENT_INLINE_H

// Nothing yet

#endif // CDOCUMENT_INLINE_H
