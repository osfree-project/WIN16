/************************************************************************
 ...
 --[ Description ]-------------------------------------------------------
  ...
  This is the inline include file for class CView - a window class for
  representing CDocument to the user. It is never instantiated
  directly, but always used as a base class for a view class.
...
/************************************************************************/
#ifndef CVIEW_INLINE_H
#define CVIEW_INLINE_H

// Nothing yet

#endif // CVIEW_INLINE_H
