/************************************************************************
 ...
 --[ Description ]-------------------------------------------------------
  ...
  This file is the inline include for the class CWinApp.
 ...
 ************************************************************************/
#ifndef CWINAPP_INLINE_H
#define CWINAPP_INLINE_H

inline CWinApp* AfxGetApp() { return(  g_pWinApp ); };

#endif // CWINAPP_INLINE_H
