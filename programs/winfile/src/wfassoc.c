...
TCHAR szShellOpenCommand[] = "\\shell\\open\\command";

TCHAR szShell[]   = "\\shell\\";
TCHAR szCommand[] = "\\command";
TCHAR szDDEExec[] = "\\ddeexec";
TCHAR szApp[]     = "\\application";
TCHAR szTopic[]   = "\\topic";
TCHAR szIFExec[]  = "\\ifexec";

TCHAR szDDEDefaultTopic[] = "System";

// These two strings must match exactly in length
TCHAR szFileManPrefix[] = "FMA000_";
TCHAR szFileManPrefixGen[] = "FMA%03x_";
#define MAX_PREFIX 0xfff

TCHAR szDotEXE[] = ".exe";
TCHAR szSpacePercentOne[] = " %1";
TCHAR szNone[32];
