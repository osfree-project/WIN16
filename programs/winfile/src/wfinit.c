...
fnStrRChr StrRChr;
fnStrCpyN StrCpyN;
TCHAR szShlwapi[] = "shlwapi";
TCHAR szShell32[] = "shell32";
TCHAR szKernel32[] = "kernel32";
...
TCHAR szNTlanman[] = "ntlanman.dll";
TCHAR szHelv[] = "MS Shell Dlg";
/*
...
JAPANEND
   ...
   hfontDriveList = CreateFont(GetHeightFromPointsString("8"),
                               0, 0,
                               0, 400, 0,
                               0,
                               0,
   ...
   if( bJAPAN) {
       hFontStatus = CreateFont(GetHeightFromPointsString("10"),
                               0, 0,
                               0, 400, 0,
                               0,
                               0,
