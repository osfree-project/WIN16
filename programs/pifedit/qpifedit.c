...
{ 0,	IDB_TASK,	BUTTON },
    ...
    { IDD_TASK,	IDT_EMSMEM,	LTEXT },
    { IDD_TASK,	IDT_EMSMIN,	LTEXT },
    { IDD_TASK,	IDE_EMSMIN,	EDIT,	EDIT_RANGE,	0,     0, 16384 },
    { IDD_TASK,	IDT_EMSMAX,	LTEXT },
    { IDD_TASK,	IDE_EMSMAX,	EDIT,	EDIT_OPTVAL, 1024,     0, 16384 },
    { IDD_TASK,	IDT_XMSMEM,	LTEXT },
    { IDD_TASK,	IDT_XMSMIN,	LTEXT },
    { IDD_TASK,	IDE_XMSMIN,	EDIT,	EDIT_RANGE,	0,     0, 16384 },
    { IDD_TASK,	IDT_XMSMAX,	LTEXT },
    { IDD_TASK,	IDE_XMSMAX,	EDIT,	EDIT_OPTVAL, 1024,     0, 16384 },
    ...
    { IDD_TASK,	IDT_VIDMEM,	LTEXT },
    { IDD_TASK,	IDB_TEXT,	BUTTON },
    { IDD_TASK,	IDB_LOW,	BUTTON },
    { IDD_TASK,	IDB_HIGH,	BUTTON },
