...
#define __egi32(a,n) (((unsigned long) ((unsigned char *)(a))[n+3] << 24) | \
                      ((unsigned long) ((unsigned char *)(a))[n+2] << 16) | \
                      ((unsigned long) ((unsigned char *)(a))[n+1] <<  8) | \
                      ((unsigned long) ((unsigned char *)(a))[n]))
